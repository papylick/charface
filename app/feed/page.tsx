  ...
  return (
    <main style={{minHeight:'100vh', background:'linear-gradient(135deg, #0a0a0f 0%, #120a1a 50%, #0a0f0a 100%)', color:'white', fontFamily:'Georgia, serif'}}>
      ...
      <div className="hero-padding" style={{textAlign:'center', padding:'48px 32px 32px'}}>
        ...
        <h1 style={{fontSize:'36px', fontWeight:'700', fontFamily:'Cinzel, serif', letterSpacing:'2px', marginBottom:'8px'}}>Akışım</h1>
      ...
      <div className="main-padding" style={{padding:'0 48px 60px', maxWidth:'1100px', margin:'0 auto'}}>
        {karakterler.length === 0 ? (
          <div style={{textAlign:'center', padding:'80px 32px'}}>
            ...
            <div style={{fontSize:'14px', color:'#444', fontFamily:'EB Garamond, serif', fontStyle:'italic', marginBottom:'24px'}}>Takip ettiğin kullanıcıların paylaşımları burada görünecek</div>
          ...
          <>
            <div style={{display:'flex', alignItems:'center', gap:'16px', marginBottom:'28px'}}>
              ...
              <h2 style={{fontSize:'11px', fontWeight:'600', color:'#c9a96e', letterSpacing:'3px', fontFamily:'Cinzel, serif'}}>{karakterler.length} PAYLAŞIM</h2>
