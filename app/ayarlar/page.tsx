...
export default function Ayarlar() {
  ...
  async function kullaniciAdiGuncelle() {
    ...
    if (mevcut && mevcut.id !== kullanici.id) {
      setKullaniciAdiMesaj('Bu kullanıcı adı alınmış!')
      return
    }
  ...
  async function hesapSil() {
    if (silOnay !== kullanici.email) {
      setSilMesaj('Email adresi eşleşmiyor!')
      return
    }
    // Karakterleri sil
        ...
        <div className="icerik-panel" style={{flex:1, padding:'32px 40px'}}>
          ...
          {aktifBolum === 'hesap' && (
            <div>
              ...
              <div className="bolum-aciklama">Kullanıcı adını ve profil bilgilerini düzenle</div>
              ...
              <div style={{background:'linear-gradient(145deg, #12101a, #1a1228)', border:'1px solid rgba(201,169,110,0.15)', borderRadius:'12px', padding:'24px', marginBottom:'20px', position:'relative', overflow:'hidden'}}>
                ...
                <div style={{display:'flex', alignItems:'center', gap:'16px', marginBottom:'20px'}}>
                  <div style={{width:'56px', height:'56px', borderRadius:'50%', background:'linear-gradient(135deg, #7F77DD, #c9a96e)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'24px', fontFamily:'Cinzel, serif', fontWeight:'700'}}>
